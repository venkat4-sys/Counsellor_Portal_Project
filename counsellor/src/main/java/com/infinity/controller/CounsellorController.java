...
public class CounsellorController {
    ...
    public Map<String, Object> loginCounsellor(@RequestBody Map<String, Object> payload) {
        ...
        try {
            ...
            Map<String, Object> counsellor = counsellorRepo.findUserByEmail(email);
            if (counsellor == null) {
    ...
    @PostMapping(value = AIMappingConstants.UPDATE_ENQUIRY_STATUS)
    public ResponseEntity<Object> updateEnquiryStatus(HttpServletRequest request,
            @RequestBody Map<String, Object> payload) {
        Map<String, Object> result = counsellorService.updateEnquiryStatus(request, payload);
        return ResponseEntity.ok(result);
    }
}
